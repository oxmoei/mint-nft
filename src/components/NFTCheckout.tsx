      ...
      <div className="max-w-screen-lg mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 content-center justify-items-center gap-6 md:gap-10">
          ...
          <div className="p-4 sm:p-6 md:p-10 w-full relative z-0 md:z-10">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(34,211,238,0.5)] tracking-tight whitespace-nowrap">
              {nft.name}
            </h1>
